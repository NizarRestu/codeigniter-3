<header class=" sticky top-0 mt-[-50px]  mb-12 px-4">
	<div class="container flex justify-between h-16 mx-auto">
		...
		<div class="items-center flex-shrink-0 hidden lg:flex">
			<button class="px-8 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900" fdprocessedid="xmmt">Log in</button>
		</div>
